...
const Index = () => {
  ...
  const { isBeginnerMode } = beginnerModeState;
  const [advancedSectionsOpen, setAdvancedSectionsOpen] = useState(true);
  ...
  return (
    <BeginnerModeContext.Provider value={beginnerModeState}>
      <div className="min-h-screen bg-background">
          ...
          <div className="container mx-auto px-4 sm:px-6">
            <div className="flex flex-col sm:flex-row items-center justify-between gap-4 mb-6">
              <BeginnerModeToggle 
                ...
                onToggle={beginnerModeState.toggleBeginnerMode} 
              />
        ...
        {/* Modeling Steps Section - Core content, always visible */}
        ...
        {/* Components Reference Section - Core content, always visible */}
        ...
        {/* Knowledge Quiz Section - Core content, always visible */}
